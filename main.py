...
async def make_transaction(transaction_in: TransactionIn):
    ...
    if user_in_db == None:                                                    #Puede entenderse como un tipo de return 
        raise HTTPException(status_code=404, detail="El usuario no existe")   #para cuando existe el error
    ...
    transaction_in_db = TransactionInDB(**transaction_in.dict(), actual_balance = user_in_db.balance) # "**" sirve para mapear en el objeto
